    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-white font-medium text-sm transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5 shadow-md hover:shadow-lg"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <p className="text-gray-500 text-xs uppercase tracking-wider mb-1">Telefon</p>
                <a
                  href={`tel:${SITE_PHONE}`}
                ...
                <p className="text-gray-500 text-xs mt-0.5">24/7</p>
              </li>
              <li>
              ...
              <li>
                <p className="text-gray-500 text-xs uppercase tracking-wider mb-1">Lokacija</p>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">© {year} Termovizija 034. Sva prava zadržana.</p>
