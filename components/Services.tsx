    ...
    icon: (
      ...
      >
        ...
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 3v3M8 4.5l1.5 2.5M16 4.5L14.5 7"
          stroke="currentColor"
          opacity="0.5"
        />
      </svg>
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 2.25c0 0-7.5 8.25-7.5 12a7.5 7.5 0 0015 0c0-3.75-7.5-12-7.5-12z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9.75 14.25a2.25 2.25 0 004.5 0"
          opacity="0.5"
        />
      </svg>
    ),
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 18h18M3 14h18M7 10c0-2 2-4 4-4s4 2 4 4"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 10c0-1 .5-2 1.5-2.5"
          opacity="0.5"
        />
    ...
    icon: (
      ...
      >
        ...
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 13.5v4M10.5 19.5c0 .828.672 1.5 1.5 1.5s1.5-.672 1.5-1.5"
          opacity="0.5"
        />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Termovizijska kamera vidi ono što ljudsko oko ne može. Koristimo je za brzo i precizno
            dijagnostikovanje problema u objektima.
          </p>
        </div>
